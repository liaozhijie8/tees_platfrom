...
export default {
  ...
  methods: {
    ...
    editCase(row) {
      ...
      this.tempCase = row
      this.$bus.$emit(this.$busEvents.api.apiCaseDrawerStatus, 'edit', this.tempCase)
    },
    ...
    copyCase(api) {
      ...
      this.$bus.$emit(this.$busEvents.api.apiCaseDrawerStatus, 'copy', this.tempCase)
    },
  ...
  beforeDestroy() {
    ...
    this.$bus.$off(this.$busEvents.api.apiCaseDrawerCommitSuccess)
  },
