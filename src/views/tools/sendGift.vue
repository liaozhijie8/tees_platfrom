...
export default {
  ...
  methods: {
    ...
    sendRequest() {
      ...
      const{threadnum, workernum, roomid, senduserId, acceptuserId} = this.sendgift
      sendgift({'threadnum': threadnum, 'workernum':workernum, 'roomid': roomid,'senduserId': senduserId,
      'acceptuserId': acceptuserId}).then(response => {
