...
export const constantRoutes = [
  ...
  //xmind用例管理
  {
    path: '/caseManage',
    component: Layout,
    redirect: '/caseManage/project',
    name: 'caseManage',
    meta: {title: '用例管理', icon: 'el-icon-connection'},
    alwaysShow: true,
    children: [
      {
        path: 'project',
        name: 'caseproject',
        component: () => import('@/views/perfTest/project/index'),
        meta: {title: 'xmind用例', icon: 'el-icon-folder-opened'}
      },
      {
        path: 'http://localhost:8094/case/caseList/1',
        meta: {title: '操作手册', icon: 'el-icon-document'}
      },
      // {
      //   path: 'role',
      //   name: 'Role',
      ...
      //   path: 'task',
      //   name: 'perfTask',
      //   component: () => import('@/views/perfTest/task/index'),
      //   meta: {title: '定时任务', icon: 'el-icon-date'}
      // },
    ]
  },
    ...
    children: [
      {
        path: 'sendGift',
        name: 'SendGift',
        component: () => import('@/views/tools/sendGift'),
        meta: {title: '房间送礼', icon: 'form'}
      },
      {
        path: 'makeUserInfo',
        name: 'MakeUserInfo',
  ...
  // 操作手册
  {
    ...
    children: [
      {
        path: 'https://docs.qq.com/doc/DYlZMdktvYVNSd0Z0',
        meta: {title: '操作手册', icon: 'el-icon-document'}
      },
      ...
      //   name: 'perfproject',
      //   component: () => import('@/views/perfTest/project/index'),
      //   meta: {title: '操作手册', icon: 'el-icon-folder-opened'}
      // },
  //     {
